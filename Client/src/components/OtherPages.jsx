    ...
    <div className="other-pages">
      ...
      <div className="footer">
        <div className="ft1">
          ...
          <a className="b1" href="/#">Media Center</a>
            <a href="/#">Privacy</a>
            <a href="/#">Speed Test</a>
          </div>
        ...
        <div className="ft2">
          ...
          <a href="/#">Jobs</a>
          <a className="b2" href="/#">Terms of Use</a>
        ...
        <div className="ft3">
          ...
          <a className="b3" href="/#">Contact Us</a>
          <a href="/#">Corporate Information</a>
          <a href="/#">Only On Netflix</a>
        </div>
        <div className="ft4">
          <a className="a1" href="/#">Media Center</a>
          <a className="a2" href="/#">Terms of Use</a>
          <a className="a3" href="/#">Contact Us</a>
        </div>
      </div>
    </div>
  );
